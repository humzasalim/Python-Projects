...
class hexapawnGame(object):
    def __init__(self, board, size, player, searchAhead):
        ...
        self.score = self.staticBoardEvaluation() # evaluation function (Will change for higher levels of tree; func used for simplicity)
    ...
    def staticBoardEvaluation(self):
